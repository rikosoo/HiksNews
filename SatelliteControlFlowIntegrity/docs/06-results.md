...
| Detection latency | 26–1376 instr (0.0010–0.0550 ms @ 25 MHz) |
...
| Modelo de CFG (lado do monitor) | 958.1 KB |
| Extração do modelo (build time) | 0.1 s |
| Volume de trace analisado | 4059 MB |
| Tempo de análise | 80 s |
